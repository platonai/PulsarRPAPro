...
& $MvnCmd -PREST-war war:war -DskipTests
...
$REMOTE_BASE_DIR = "/home/$User/platonic.fun/repo/ai/platon/exotic"

# Create remote directory
ssh "$User@$TargetHost" "mkdir -p $REMOTE_BASE_DIR"
...
ssh "$User@$TargetHost" "ls -l $REMOTE_BASE_DIR"

ssh "$User@$TargetHost" "unlink $REMOTE_BASE_DIR/PulsarRPAPro.jar"
ssh "$User@$TargetHost" "ln -s $REMOTE_BASE_DIR/exotic-standalone-$VERSION.jar $REMOTE_BASE_DIR/PulsarRPAPro.jar"
