...
*#Never write another web scraper. Exotic generates all the scraping rules automatically and manages the crawler in detail:#*

. STEP1: automatically extract every field in webpages using advanced AI and generate scraping SQLs
. STEP2: test and improve scraping SQLs to match frontend business requirements if necessary
. STEP3: create crawl rules in the web console to run scraping SQLs continuously

Check out https://github.com/platonai/pulsar[Pulsar] to see the full power of Exotic.
