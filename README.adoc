...
*#Never write another web scraper. Exotic automatically generates all the extract rules, query the Web as a database, scraping web data at large scale accurately and completely:#*
