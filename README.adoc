...
*#Never write another web scraper. Exotic learns from the website, automatically generates the extract rules, queries the Web as a database, and delivers web data completely and accurately at scale:#*
