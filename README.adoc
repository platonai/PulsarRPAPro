...
. STEP1: automatically extract every field in webpages using our advanced AI and generate scraping SQLs
. STEP2: check the scraping SQLs, test and improve them if necessary
