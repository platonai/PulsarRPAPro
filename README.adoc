...
*#Never write another web scraper. Exotic automatically generates all the extract rules, query the Web just like the local database and manages the crawlers in detail:#*
