...
*#Never write another web scraper. Exotic learns from the website, automatically generates the extract rules, query the Web as a database, scraping web data at large scale accurately and completely:#*
